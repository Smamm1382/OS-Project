...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
      ...
      2b:	e8 59 0e 00 00       	call   e89 <open>
...
fork1(void)
{
  ...
  pid = fork();
      50:	e8 ec 0d 00 00       	call   e41 <fork>
  if(pid == -1)
    ...
    wait();
      62:	e8 ea 0d 00 00       	call   e51 <wait>
  printf(2, "$ ");
  ...
  if(buf[0] == 0) // EOF
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      ...
      b5:	50                   	push   %eax
      b6:	e8 b6 0d 00 00       	call   e71 <close>
      break;
      ...
      if(chdir(buf+3) < 0)
      f0:	e8 c4 0d 00 00       	call   eb9 <chdir>
  ...
  exit();
     11a:	e8 2a 0d 00 00       	call   e49 <exit>
    panic("fork");
...
00000170 <panic>:
{
  ...
  exit();
     185:	e8 bf 0c 00 00       	call   e49 <exit>
...
00000190 <fork1>:
{
  ...
  pid = fork();
     196:	e8 a6 0c 00 00       	call   e41 <fork>
  if(pid == -1)
...
000001b0 <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    exec(ecmd->argv[0], ecmd->argv);
     ...
     1dc:	52                   	push   %edx
     1dd:	50                   	push   %eax
     1de:	e8 9e 0c 00 00       	call   e81 <exec>
    ...
    break;
     ...
     1ff:	90                   	nop
    exit();
     200:	e8 44 0c 00 00       	call   e49 <exit>
    if(fork1() == 0)
    ...
    if(pipe(p) < 0)
     ...
     219:	50                   	push   %eax
     21a:	e8 3a 0c 00 00       	call   e59 <pipe>
    ...
    close(p[0]);
     ...
     24a:	e8 22 0c 00 00       	call   e71 <close>
    close(p[1]);
     24f:	58                   	pop    %eax
     250:	ff 75 f4             	push   -0xc(%ebp)
     253:	e8 19 0c 00 00       	call   e71 <close>
    wait();
     258:	e8 f4 0b 00 00       	call   e51 <wait>
    wait();
     25d:	e8 ef 0b 00 00       	call   e51 <wait>
    break;
    ...
    wait();
     270:	e8 dc 0b 00 00       	call   e51 <wait>
    runcmd(lcmd->right);
    ...
    close(rcmd->fd);
     ...
     286:	e8 e6 0b 00 00       	call   e71 <close>
    if(open(rcmd->file, rcmd->mode) < 0){
     28b:	58                   	pop    %eax
     28c:	5a                   	pop    %edx
     28d:	ff 73 10             	push   0x10(%ebx)
     290:	ff 73 08             	push   0x8(%ebx)
     293:	e8 f1 0b 00 00       	call   e89 <open>
    ...
    panic("runcmd");
     ...
     2c2:	e8 e9 0c 00 00       	call   fb0 <printf>
      exit();
     2c7:	e8 7d 0b 00 00       	call   e49 <exit>
      panic("pipe");
     ...
     2dc:	6a 01                	push   $0x1
     2de:	e8 8e 0b 00 00       	call   e71 <close>
      dup(p[1]);
     2e3:	58                   	pop    %eax
     2e4:	ff 75 f4             	push   -0xc(%ebp)
     2e7:	e8 d5 0b 00 00       	call   ec1 <dup>
      close(p[0]);
     2ec:	58                   	pop    %eax
     2ed:	ff 75 f0             	push   -0x10(%ebp)
     2f0:	e8 7c 0b 00 00       	call   e71 <close>
      close(p[1]);
     2f5:	58                   	pop    %eax
     2f6:	ff 75 f4             	push   -0xc(%ebp)
     2f9:	e8 73 0b 00 00       	call   e71 <close>
      runcmd(pcmd->left);
     2fe:	5a                   	pop    %edx
     ...
     30a:	6a 00                	push   $0x0
     30c:	e8 60 0b 00 00       	call   e71 <close>
      dup(p[0]);
     311:	5a                   	pop    %edx
     312:	ff 75 f0             	push   -0x10(%ebp)
     315:	e8 a7 0b 00 00       	call   ec1 <dup>
      close(p[0]);
     31a:	59                   	pop    %ecx
     31b:	ff 75 f0             	push   -0x10(%ebp)
     31e:	e8 4e 0b 00 00       	call   e71 <close>
      close(p[1]);
     323:	58                   	pop    %eax
     324:	ff 75 f4             	push   -0xc(%ebp)
     327:	e8 45 0b 00 00       	call   e71 <close>
      runcmd(pcmd->right);
     32c:	58                   	pop    %eax
     ...
     cf9:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i=0; i+1 < max; ){
    ...
    cc = read(0, &c, 1);
     ...
     d05:	57                   	push   %edi
     d06:	6a 00                	push   $0x0
     d08:	e8 54 01 00 00       	call   e61 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     d6d:	e8 17 01 00 00       	call   e89 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
     ...
     d81:	50                   	push   %eax
     d82:	e8 1a 01 00 00       	call   ea1 <fstat>
  close(fd);
     d87:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
     d8a:	89 c6                	mov    %eax,%esi
  close(fd);
     d8c:	e8 e0 00 00 00       	call   e71 <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void* arg1, void* arg2)
{
  ...
  stack = malloc(PGSIZE);
     ...
     e2b:	e8 b0 03 00 00       	call   11e0 <malloc>
  ...
  return clone(start_routine, arg1, arg2, stack);
     ...
     e3a:	e8 aa 00 00 00       	call   ee9 <clone>
}
     e3f:	c9                   	leave  
     e40:	c3                   	ret    
...
00000e49 <exit>:
SYSCALL(exit)
     e49:	b8 02 00 00 00       	mov    $0x2,%eax
     e4e:	cd 40                	int    $0x40
     e50:	c3                   	ret    

00000e51 <wait>:
SYSCALL(wait)
     e51:	b8 03 00 00 00       	mov    $0x3,%eax
     e56:	cd 40                	int    $0x40
     e58:	c3                   	ret    

00000e59 <pipe>:
SYSCALL(pipe)
     e59:	b8 04 00 00 00       	mov    $0x4,%eax
     e5e:	cd 40                	int    $0x40
     e60:	c3                   	ret    

00000e61 <read>:
SYSCALL(read)
     e61:	b8 05 00 00 00       	mov    $0x5,%eax
     e66:	cd 40                	int    $0x40
     e68:	c3                   	ret    

00000e69 <write>:
SYSCALL(write)
     e69:	b8 10 00 00 00       	mov    $0x10,%eax
     e6e:	cd 40                	int    $0x40
     e70:	c3                   	ret    

00000e71 <close>:
SYSCALL(close)
     e71:	b8 15 00 00 00       	mov    $0x15,%eax
     e76:	cd 40                	int    $0x40
     e78:	c3                   	ret    

00000e79 <kill>:
SYSCALL(kill)
     e79:	b8 06 00 00 00       	mov    $0x6,%eax
     e7e:	cd 40                	int    $0x40
     e80:	c3                   	ret    

00000e81 <exec>:
SYSCALL(exec)
     e81:	b8 07 00 00 00       	mov    $0x7,%eax
     e86:	cd 40                	int    $0x40
     e88:	c3                   	ret    

00000e89 <open>:
SYSCALL(open)
     e89:	b8 0f 00 00 00       	mov    $0xf,%eax
     e8e:	cd 40                	int    $0x40
     e90:	c3                   	ret    

00000e91 <mknod>:
SYSCALL(mknod)
     e91:	b8 11 00 00 00       	mov    $0x11,%eax
     e96:	cd 40                	int    $0x40
     e98:	c3                   	ret    

00000e99 <unlink>:
SYSCALL(unlink)
     e99:	b8 12 00 00 00       	mov    $0x12,%eax
     e9e:	cd 40                	int    $0x40
     ea0:	c3                   	ret    

00000ea1 <fstat>:
SYSCALL(fstat)
     ea1:	b8 08 00 00 00       	mov    $0x8,%eax
     ea6:	cd 40                	int    $0x40
     ea8:	c3                   	ret    

00000ea9 <link>:
SYSCALL(link)
     ea9:	b8 13 00 00 00       	mov    $0x13,%eax
     eae:	cd 40                	int    $0x40
     eb0:	c3                   	ret    

00000eb1 <mkdir>:
SYSCALL(mkdir)
     eb1:	b8 14 00 00 00       	mov    $0x14,%eax
     eb6:	cd 40                	int    $0x40
     eb8:	c3                   	ret    

00000eb9 <chdir>:
SYSCALL(chdir)
     eb9:	b8 09 00 00 00       	mov    $0x9,%eax
     ebe:	cd 40                	int    $0x40
     ec0:	c3                   	ret    

00000ec1 <dup>:
SYSCALL(dup)
     ec1:	b8 0a 00 00 00       	mov    $0xa,%eax
     ec6:	cd 40                	int    $0x40
     ec8:	c3                   	ret    

00000ec9 <getpid>:
SYSCALL(getpid)
     ec9:	b8 0b 00 00 00       	mov    $0xb,%eax
     ece:	cd 40                	int    $0x40
     ed0:	c3                   	ret    

00000ed1 <sbrk>:
SYSCALL(sbrk)
     ed1:	b8 0c 00 00 00       	mov    $0xc,%eax
     ed6:	cd 40                	int    $0x40
     ed8:	c3                   	ret    

00000ed9 <sleep>:
SYSCALL(sleep)
     ed9:	b8 0d 00 00 00       	mov    $0xd,%eax
     ede:	cd 40                	int    $0x40
     ee0:	c3                   	ret    

00000ee1 <uptime>:
SYSCALL(uptime)
     ee1:	b8 0e 00 00 00       	mov    $0xe,%eax
     ee6:	cd 40                	int    $0x40
     ee8:	c3                   	ret    

00000ee9 <clone>:
SYSCALL(clone)
     ee9:	b8 16 00 00 00       	mov    $0x16,%eax
     eee:	cd 40                	int    $0x40
     ef0:	c3                   	ret    
     ...
     f0c:	89 d1                	mov    %edx,%ecx
{
  ...
  write(fd, &c, 1);
     ...
     f7e:	56                   	push   %esi
     f7f:	57                   	push   %edi
     f80:	e8 e4 fe ff ff       	call   e69 <write>
  while(--i >= 0)
     ...
     fb9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  write(fd, &c, 1);
     ...
     ff5:	57                   	push   %edi
     ff6:	56                   	push   %esi
     ff7:	e8 6d fe ff ff       	call   e69 <write>
  ...
  write(fd, &c, 1);
    ...
    104e:	e8 16 fe ff ff       	call   e69 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    105f:	57                   	push   %edi
    1060:	56                   	push   %esi
    1061:	e8 03 fe ff ff       	call   e69 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    10cb:	57                   	push   %edi
    10cc:	56                   	push   %esi
    10cd:	e8 97 fd ff ff       	call   e69 <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    110f:	e8 55 fd ff ff       	call   e69 <write>
        ap++;
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1243:	e8 89 fc ff ff       	call   ed1 <sbrk>
  if(p == (char*)-1)
