...
int thread_create(void (*start_routine)(void *, void *), void* arg1, void* arg2)
{
 ...
 2cb:	e8 00 04 00 00       	call   6d0 <malloc>
 ...
 2da:	e8 f6 00 00 00       	call   3d5 <clone>
}
 2df:	c9                   	leave  
 2e0:	c3                   	ret    
...
free(void *ap)
{
 ...
 641:	a1 64 0b 00 00       	mov    0xb64,%eax
{
 ...
 681:	5b                   	pop    %ebx
  freep = p;
 682:	89 15 64 0b 00 00    	mov    %edx,0xb64
}
 688:	5e                   	pop    %esi
 689:	5f                   	pop    %edi
 68a:	5d                   	pop    %ebp
 ...
 6b9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6bc:	89 15 64 0b 00 00    	mov    %edx,0xb64
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 3d 64 0b 00 00    	mov    0xb64,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 71f:	73 4f                	jae    770 <malloc+0xa0>
    ...
    if(p == freep)
 721:	8b 3d 64 0b 00 00    	mov    0xb64,%edi
 ...
 74a:	e8 f1 fe ff ff       	call   640 <free>
  return freep;
 74f:	8b 15 64 0b 00 00    	mov    0xb64,%edx
 ...
 77c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 77f:	89 15 64 0b 00 00    	mov    %edx,0xb64
}
 ...
 78f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 790:	c7 05 64 0b 00 00 68 	movl   $0xb68,0xb64
 797:	0b 00 00 
    base.s.size = 0;
 79a:	bf 68 0b 00 00       	mov    $0xb68,%edi
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 68 0b 00 00 68 	movl   $0xb68,0xb68
 7a6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7a9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7ab:	c7 05 6c 0b 00 00 00 	movl   $0x0,0xb6c
 7b2:	00 00 00 
    if(p->s.size >= nunits){
