...
main(int argc, char *argv[])
{
  ...
  33:	6a 00                	push   $0x0
  35:	ff 33                	push   (%ebx)
  37:	e8 fd 03 00 00       	call   439 <open>
  ...
  59:	e8 c3 03 00 00       	call   421 <close>
  for(i = 1; i < argc; i++){
  ...
  exit();
  66:	e8 8e 03 00 00       	call   3f9 <exit>
      printf(1, "wc: cannot open %s\n", argv[i]);
  6b:	50                   	push   %eax
  6c:	ff 33                	push   (%ebx)
  ...
  75:	e8 e6 04 00 00       	call   560 <printf>
      exit();
  7a:	e8 7a 03 00 00       	call   3f9 <exit>
    wc(0, "");
  7f:	52                   	push   %edx
  80:	52                   	push   %edx
  ...
  88:	e8 13 00 00 00       	call   a0 <wc>
    exit();
  8d:	e8 67 03 00 00       	call   3f9 <exit>
  92:	66 90                	xchg   %ax,%ax
  94:	66 90                	xchg   %ax,%ax
  96:	66 90                	xchg   %ax,%ax
  98:	66 90                	xchg   %ax,%ax
  ...
  a6:	31 db                	xor    %ebx,%ebx
{
  ...
  d0:	e8 3c 03 00 00       	call   411 <read>
 ...
 16f:	e8 ec 03 00 00       	call   560 <printf>
    exit();
 174:	e8 80 02 00 00       	call   3f9 <exit>
 ...
 2a9:	31 db                	xor    %ebx,%ebx
{
 ...
 2b5:	57                   	push   %edi
 2b6:	6a 00                	push   $0x0
 2b8:	e8 54 01 00 00       	call   411 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 31d:	e8 17 01 00 00       	call   439 <open>
  if(fd < 0)
 ...
 331:	50                   	push   %eax
 332:	e8 1a 01 00 00       	call   451 <fstat>
  close(fd);
 337:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 33a:	89 c6                	mov    %eax,%esi
  close(fd);
 33c:	e8 e0 00 00 00       	call   421 <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void* arg1, void* arg2)
{
 ...
 3db:	e8 b0 03 00 00       	call   790 <malloc>
 ...
 3ea:	e8 aa 00 00 00       	call   499 <clone>
}
 3ef:	c9                   	leave  
 3f0:	c3                   	ret    
 ...
 569:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5a5:	57                   	push   %edi
 5a6:	56                   	push   %esi
 5a7:	e8 6d fe ff ff       	call   419 <write>
 ...
 5fe:	e8 16 fe ff ff       	call   419 <write>
        putc(fd, c);
 ...
 60f:	57                   	push   %edi
 610:	56                   	push   %esi
 611:	e8 03 fe ff ff       	call   419 <write>
        putc(fd, c);
 ...
 67b:	57                   	push   %edi
 67c:	56                   	push   %esi
 67d:	e8 97 fd ff ff       	call   419 <write>
        while(*s != 0){
 ...
 6bc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 6bf:	e8 55 fd ff ff       	call   419 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 7f3:	e8 89 fc ff ff       	call   481 <sbrk>
  if(p == (char*)-1)
