...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	push   (%ebx)
  35:	e8 5b 03 00 00       	call   395 <unlink>
  ...
  exit();
  4b:	e8 f5 02 00 00       	call   345 <exit>
      printf(2, "rm: %s failed to delete\n", argv[i]);
  50:	50                   	push   %eax
  51:	ff 33                	push   (%ebx)
  ...
  6d:	e8 3e 04 00 00       	call   4b0 <printf>
    exit();
  72:	e8 ce 02 00 00       	call   345 <exit>
  77:	66 90                	xchg   %ax,%ax
  79:	66 90                	xchg   %ax,%ax
  7b:	66 90                	xchg   %ax,%ax
  7d:	66 90                	xchg   %ax,%ax
 ...
 1a9:	31 db                	xor    %ebx,%ebx
{
 ...
 1b5:	57                   	push   %edi
 1b6:	6a 00                	push   $0x0
 1b8:	e8 a0 01 00 00       	call   35d <read>
    if(cc < 1)
...
int thread_create(void (*start_routine)(void *, void *), void* arg1, void* arg2)
{
 ...
 2db:	e8 00 04 00 00       	call   6e0 <malloc>
 ...
 2ea:	e8 f6 00 00 00       	call   3e5 <clone>
}
 2ef:	c9                   	leave  
 2f0:	c3                   	ret    
 ...
 4b9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 637:	90                   	nop
          s = "(null)";
 638:	ba 05 08 00 00       	mov    $0x805,%edx
        while(*s != 0){
