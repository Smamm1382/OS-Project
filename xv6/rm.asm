...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	push   (%ebx)
  35:	e8 0f 03 00 00       	call   349 <unlink>
  ...
  exit();
  4b:	e8 a9 02 00 00       	call   2f9 <exit>
      printf(2, "rm: %s failed to delete\n", argv[i]);
  50:	50                   	push   %eax
  51:	ff 33                	push   (%ebx)
  ...
  6d:	e8 ee 03 00 00       	call   460 <printf>
    exit();
  72:	e8 82 02 00 00       	call   2f9 <exit>
  77:	66 90                	xchg   %ax,%ax
  79:	66 90                	xchg   %ax,%ax
  7b:	66 90                	xchg   %ax,%ax
  7d:	66 90                	xchg   %ax,%ax
 ...
 1a9:	31 db                	xor    %ebx,%ebx
{
 ...
 1b5:	57                   	push   %edi
 1b6:	6a 00                	push   $0x0
 1b8:	e8 54 01 00 00       	call   311 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 21d:	e8 17 01 00 00       	call   339 <open>
  if(fd < 0)
 ...
 231:	50                   	push   %eax
 232:	e8 1a 01 00 00       	call   351 <fstat>
  close(fd);
 237:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 23a:	89 c6                	mov    %eax,%esi
  close(fd);
 23c:	e8 e0 00 00 00       	call   321 <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void* arg1, void* arg2)
{
 ...
 2db:	e8 b0 03 00 00       	call   690 <malloc>
 ...
 2ea:	e8 aa 00 00 00       	call   399 <clone>
}
 2ef:	c9                   	leave  
 2f0:	c3                   	ret    
...
free(void *ap)
{
 ...
 601:	a1 ec 0a 00 00       	mov    0xaec,%eax
{
 ...
 641:	5b                   	pop    %ebx
  freep = p;
 642:	89 15 ec 0a 00 00    	mov    %edx,0xaec
}
 648:	5e                   	pop    %esi
 649:	5f                   	pop    %edi
 64a:	5d                   	pop    %ebp
 ...
 679:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 67c:	89 15 ec 0a 00 00    	mov    %edx,0xaec
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 3d ec 0a 00 00    	mov    0xaec,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6df:	73 4f                	jae    730 <malloc+0xa0>
    ...
    if(p == freep)
 6e1:	8b 3d ec 0a 00 00    	mov    0xaec,%edi
 ...
 70a:	e8 f1 fe ff ff       	call   600 <free>
  return freep;
 70f:	8b 15 ec 0a 00 00    	mov    0xaec,%edx
 ...
 757:	0a 00 00 
    base.s.size = 0;
 75a:	bf f0 0a 00 00       	mov    $0xaf0,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 769:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 76b:	c7 05 f4 0a 00 00 00 	movl   $0x0,0xaf4
 772:	00 00 00 
    if(p->s.size >= nunits){
