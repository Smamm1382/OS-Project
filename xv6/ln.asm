   ...
   a:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  20:	e8 6b 04 00 00       	call   490 <printf>
    exit();
  25:	e8 fb 02 00 00       	call   325 <exit>
  }
  ...
  32:	e8 4e 03 00 00       	call   385 <link>
  37:	83 c4 10             	add    $0x10,%esp
  3a:	85 c0                	test   %eax,%eax
  3c:	78 05                	js     43 <main+0x43>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
  exit();
  3e:	e8 e2 02 00 00       	call   325 <exit>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
...
int thread_create(void (*start_routine)(void *, void *), void* arg1, void* arg2)
{
 ...
 2bb:	e8 00 04 00 00       	call   6c0 <malloc>
 ...
 2ca:	e8 f6 00 00 00       	call   3c5 <clone>
}
 2cf:	c9                   	leave  
 2d0:	c3                   	ret    
 ...
 499:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 617:	90                   	nop
          s = "(null)";
 618:	ba df 07 00 00       	mov    $0x7df,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 631:	a1 6c 0b 00 00       	mov    0xb6c,%eax
{
 ...
 671:	5b                   	pop    %ebx
  freep = p;
 672:	89 15 6c 0b 00 00    	mov    %edx,0xb6c
}
 678:	5e                   	pop    %esi
 679:	5f                   	pop    %edi
 67a:	5d                   	pop    %ebp
 ...
 6a9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ac:	89 15 6c 0b 00 00    	mov    %edx,0xb6c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 3d 6c 0b 00 00    	mov    0xb6c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 70f:	73 4f                	jae    760 <malloc+0xa0>
    ...
    if(p == freep)
 711:	8b 3d 6c 0b 00 00    	mov    0xb6c,%edi
 ...
 73a:	e8 f1 fe ff ff       	call   630 <free>
  return freep;
 73f:	8b 15 6c 0b 00 00    	mov    0xb6c,%edx
 ...
 76c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 76f:	89 15 6c 0b 00 00    	mov    %edx,0xb6c
}
 ...
 77f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 780:	c7 05 6c 0b 00 00 70 	movl   $0xb70,0xb6c
 787:	0b 00 00 
    base.s.size = 0;
 78a:	bf 70 0b 00 00       	mov    $0xb70,%edi
    base.s.ptr = freep = prevp = &base;
 78f:	c7 05 70 0b 00 00 70 	movl   $0xb70,0xb70
 796:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 799:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 79b:	c7 05 74 0b 00 00 00 	movl   $0x0,0xb74
 7a2:	00 00 00 
    if(p->s.size >= nunits){
