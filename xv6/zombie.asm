...
main(void)
{
  ...
  if(fork() > 0)
  11:	e8 8b 02 00 00       	call   2a1 <fork>
  16:	85 c0                	test   %eax,%eax
  18:	7e 0d                	jle    27 <main+0x27>
    sleep(5);  // Let child exit before parent.
  1a:	83 ec 0c             	sub    $0xc,%esp
  1d:	6a 05                	push   $0x5
  1f:	e8 15 03 00 00       	call   339 <sleep>
  24:	83 c4 10             	add    $0x10,%esp
  exit();
  27:	e8 7d 02 00 00       	call   2a9 <exit>
  2c:	66 90                	xchg   %ax,%ax
  2e:	66 90                	xchg   %ax,%ax
 ...
 159:	31 db                	xor    %ebx,%ebx
{
 ...
 165:	57                   	push   %edi
 166:	6a 00                	push   $0x0
 168:	e8 54 01 00 00       	call   2c1 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1cd:	e8 17 01 00 00       	call   2e9 <open>
  if(fd < 0)
 ...
 1e1:	50                   	push   %eax
 1e2:	e8 1a 01 00 00       	call   301 <fstat>
  close(fd);
 1e7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 1ea:	89 c6                	mov    %eax,%esi
  close(fd);
 1ec:	e8 e0 00 00 00       	call   2d1 <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void* arg1, void* arg2)
{
 ...
 28b:	e8 b0 03 00 00       	call   640 <malloc>
 ...
 29a:	e8 aa 00 00 00       	call   349 <clone>
}
 29f:	c9                   	leave  
 2a0:	c3                   	ret    
 ...
 36c:	89 d1                	mov    %edx,%ecx
{
 ...
 3de:	56                   	push   %esi
 3df:	57                   	push   %edi
 3e0:	e8 e4 fe ff ff       	call   2c9 <write>
  while(--i >= 0)
 ...
 419:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 455:	57                   	push   %edi
 456:	56                   	push   %esi
 457:	e8 6d fe ff ff       	call   2c9 <write>
 ...
 4ae:	e8 16 fe ff ff       	call   2c9 <write>
        putc(fd, c);
 ...
 4bf:	57                   	push   %edi
 4c0:	56                   	push   %esi
 4c1:	e8 03 fe ff ff       	call   2c9 <write>
        putc(fd, c);
 ...
 52b:	57                   	push   %edi
 52c:	56                   	push   %esi
 52d:	e8 97 fd ff ff       	call   2c9 <write>
        while(*s != 0){
 ...
 56c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 56f:	e8 55 fd ff ff       	call   2c9 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 6a3:	e8 89 fc ff ff       	call   331 <sbrk>
  if(p == (char*)-1)
